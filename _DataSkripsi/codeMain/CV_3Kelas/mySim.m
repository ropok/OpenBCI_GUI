...
for j = 1:size(data_pr1,2)
    ...
    compData3 = data_pr1(3,j);

    if compData1 > compData2 && compData1 > compData3
        data_pr2(1,j) = 1;
        data_pr2(2,j) = 0;
        data_pr2(3,j) = 0;
        elseif compData2 > compData1 && compData2 > compData3
                data_pr2(1,j) = 0;
                data_pr2(2,j) = 1;
                data_pr2(3,j) = 0;
        elseif compData3 > compData1 && compData3 > compData2
                data_pr2(1,j) = 0;
                data_pr2(2,j) = 0;
                data_pr2(3,j) = 1;
    end
...
% 
    ...
    n = N/3;
    target(1,1:n) = ones;
        target(2,n+1:n*2) = ones;
            target(3,(n*2)+1:N) = ones;

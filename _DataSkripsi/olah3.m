...
%% R21
load('D:\Jaler\OpenBCI_GUI\_DataSkripsi\R21.txt');
data_raw = R21;
...
for i=1:4
 ...
 %        {data_raw(6691:7492,i)};{data_raw(8504:9106,i)}];
    ...
    %% R21
    N{i} = [{data_raw(1451:1474,i)};{data_raw(2168:2197,i)};{data_raw(2980:3586,i)};...
        {data_raw(4375:4390,i)};{data_raw(5075:5844,i)};{data_raw(6590:6613,i)};...
        {data_raw(7408:7450,i)};{data_raw(8263:9297,i)};{data_raw(10049:10786,i)};...
        {data_raw(11477:11524,i)};{data_raw(12194:13168,i)}];
    L{i} = [{data_raw(785:1450,i)};{data_raw(2198:2979,i)};{data_raw(4391:5074,i)};...
        {data_raw(6614:7407,i)};{data_raw(9298:10048,i)};{data_raw(11525:12193,i)}];
    R{i} = [{data_raw(1475:2167,i)};{data_raw(3587:4374,i)};{data_raw(5845:6589,i)};...
        {data_raw(7451:8262,i)};{data_raw(10787:11476,i)}];
